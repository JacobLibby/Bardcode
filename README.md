...
In its current stage, Bardcode uses Streamlit as a frontend, displaying the UI and allowing for user input of barcodes.

1. git clone this repo and navigate to the project folder in your terminal, entering the venv
